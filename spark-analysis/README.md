...
1) General:
    ...
    - `make RDDF`		-- RDDF
    - `make RDDR`		-- RDDR
    - `make awsreprdd`		-- Replicated side join using RDD in AWS
    - `make awsrepds`		-- Replicated side join using DataSet in AWS
    - `make awsredrdd`		-- Reduce side join using RDD in AWS
    - `make awsredds`		-- Reduce side join using DataSet in AWS
