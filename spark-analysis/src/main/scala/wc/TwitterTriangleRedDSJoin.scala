...
object TwitterTriangleRedDSJoin {

  def main(args: Array[String]) {
    val logger: org.apache.log4j.Logger = LogManager.getRootLogger
    val spark = SparkSession.builder()
      .appName("TwitterFollowerTriangleRedDSCount")
